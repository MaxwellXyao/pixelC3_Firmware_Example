...
void pixelC_HW_OLED_WrDat(u8 dat);
void pixelC_HW_OLED_WrCmd(u8 cmd);
void pixelC_HW_OLED_Set_Pos(u8 x,u8 y);
void pixelC_HW_OLED_Fill(u8 bmp_dat);

//##############################【API】##############################
void pixelC_HW_OLED_Init(void);			//OLED硬件初始化
void pixelC_HW_OLED_P6x8Str(u8 x,u8 y,u8 ch[]); 	//硬件写字符串:硬件测试
